...
class MemoriesBlinkingCharacters constructor(context: Context): AbstractAnimation(context) {
    ...
    override fun update() {
        ...
        if (counter == modulo) {
            ...
            if (currentCharacter == Memories.characterCount) {
                currentCharacter = 0
                setFinished()
            }
        }
    ...
    override fun draw(canvas: Canvas) {
        canvas.drawRect(Memories.characterRects[currentCharacter], paint)
    }
